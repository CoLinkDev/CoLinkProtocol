...
| 6007 | note storage limit reached | 413 | A configured per-item limit or the account's Notes storage quota has been reached | [Notes limits](notes/README.md#limits-and-pagination), [create-note](notes/notes-and-tags/create-note.md), [update-note](notes/notes-and-tags/update-note.md), [create-tag](notes/notes-and-tags/create-tag.md), [update-tag](notes/notes-and-tags/update-tag.md), [upload attachment](notes/attachments/upload.md) |
| 6008 | invalid note reference | 409 | `tagIds` or `attachmentIds` contains an invalid, deleted, or misowned resource | [create-note](notes/notes-and-tags/create-note.md), [update-note](notes/notes-and-tags/update-note.md) |
| 6009 | sync cursor expired | 410 | Incremental sync cursor has expired; client must perform a full snapshot sync | [snapshot](notes/notes-and-tags/snapshot.md), [incremental sync](notes/notes-and-tags/changes.md) |
...
| 6011 | attachment ID unavailable | 409 | The submitted `attachmentId` is already reserved by an active attachment or tombstone in this account | [upload attachment](notes/attachments/upload.md) |
