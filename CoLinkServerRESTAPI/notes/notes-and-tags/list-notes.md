...
|------|---------|-------------|-------------|
| 4002 | invalid parameter | 400 | `limit` is outside `1..500`, `pageToken` is malformed, or `tagId` is not a valid UUID v4 |
| 6003 | tag not found | 404 | The requested `tagId` does not exist or has been deleted |
