...
| LAN Pairing | The process of establishing mutual trust between two devices via LAN handshake with user-confirmed pairing code. See [CoLinkLAN/websocket.md](../CoLinkLAN/websocket.md) for protocol details. |
