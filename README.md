...
- New capabilities MUST document the earliest supporting version, behavior when peers have mismatched versions, and degradation paths for lower-version nodes.
